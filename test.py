...
def download_page_content(page_id, page_title, output_filename):
    """Downloads the page content and saves it as a .html file."""
...
def download_page_and_subpages(page_id, output_dir):
    ...
    output_filename = os.path.join(output_dir, f"{page_id}_{sanitized_title}.html")
    download_page_content(page_id, page_title, output_filename)
    ...
    for sub_page in sub_pages:
        ...
        sub_output_filename = os.path.join(output_dir, f"{sub_page_id}_{sanitized_sub_title}.html")
        print(f"Downloading sub-page: {sub_page_title} (ID: {sub_page_id})")
        download_page_content(sub_page_id, sub_page_title, sub_output_filename)
